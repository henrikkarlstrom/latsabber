...
Første steg er å hente ut publikasjonene fra Cristin. Vi nøyer oss med å se på vitenskapelige artikler i denne omgang, og ser på publiseringsår 2017 for å fange opp eventuelle embargorestriksjoner på de arkiverte publikasjonene:

```{r cristin_uttrekk, echo = FALSE}
...
```{r restultat_analyse, eval = FALSE}
# sjekke oa_status
resultater %>%
  count(open_access)
